...
class CreateAccountConfirmCodeForm  extends StatelessWidget {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/create_account_confirmation_bg.jpg"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
